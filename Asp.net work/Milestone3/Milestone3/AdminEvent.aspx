<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEvent.aspx.cs" Inherits="Milestone3.AdminEvent" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Please enter the required information to<br />
            remove an event from the system:<br />
            <br />
            Event ID:<br />
            <br />
            <asp:TextBox ID="eventIdRemoveBox" runat="server"></asp:TextBox>
            <br />
            <br />
            User ID:<br />
            <br />
            <asp:TextBox ID="userIdRemoveBox" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button5" runat="server" Text="Remove" OnClick="Button5_Click" />
            <br />
            <br />
            <br />
            <asp:Button ID="Button6" runat="server" Text="Return to your Profile" OnClick="Button6_Click" />
            <br />
            <br />
            <br />
            <br />
