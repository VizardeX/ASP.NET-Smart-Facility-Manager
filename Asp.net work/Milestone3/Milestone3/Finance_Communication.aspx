<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Finance_Communication.aspx.cs" Inherits="Milestone3.Finance_Communication" %>
    ...
    <form id="form1" runat="server">
        <div>
               ...
               <p>
                ...
                <p>
                    <asp:TextBox ID ="showMesBox" runat="server"></asp:TextBox>
                </p>
                ...
                <p>
                    To delete previous message, please enter the following:
                </p>
                <p>
                    Receiver ID:
                </p>
                ...
                <p>
                 ...
                 <p>
                   <asp:Button ID="deleteMsg" runat="server" Text="Delete Previous Message" OnClick="delete_Click" />
               </p>
        </div>
    </form>
</body>
